...
*/}
      ...
      <div className='flex lg:text-xl w-full p-2   space-x-10'>
        <button className='md:p-5  p-2 w-56 rounded-lg  hover:scale-95 hover:bg-gradient-to-l transition-all  duration-500 bg-gradient-to-l from-blue-200 via-blue-300 to-blue-400  '>
          Get In Touch</button>
        <button className='md:p-5  p-2 w-56 rounded-lg bg-transparent  border-sky-500 hover:border-none hover:scale-95 hover:bg-gradient-to-l transition-all  duration-500  from-blue-200 via-blue-300 to-blue-400  '>
