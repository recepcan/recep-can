...
function SignIn() {
    ...
    return (
        ...
        <div className='w-full p-10 space-x-5 min-h-screen font-inter bg-gray-100 
        flex md:flex-row flex-col items-center justify-center'>


            <div className="md:w-1/3 w-full  md:h-[600px] p-3 md:p-10 bg-gray-100 
            ...
            <div className="md:w-1/2 w-full md:h-[400px] md:p-10 p-3  flex flex-col items-center  lg:justify-center ">
                <form onSubmit={handleSubmit} className='flex  flex-col h-full   md:justify-evenly
                 w-full md:w-2/3 gap-5  shadow-gray-400 p-5 rounded-lg bg-gray-100' >

                    <div className='space-y-3'>

                        <div className='text-sm font-bold'>
                            your email
                            <input id='email' onChange={handleChange} className='p-3  border-2 rounded-lg bg-gray-100 outline-none w-full'
                             type="email" 
                             placeholder='email' />
                        </div>
                        ...
                        className='text-sm font-bold'>
                            ...
                            className='p-3  border-2 rounded-lg bg-gray-100 outline-none w-full'
                             type="password" 
