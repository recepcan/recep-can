  ...
  return (
    ...
    <div className='w-[90%] h-full flex border-white'>
      <div className='w-1/2 h-full space-y-5 flex flex-col justify-center text-start border-white  '>
        ...
        <div className='w-[630px] h-[400px] p-2 box-border shadow-xl shadow-gray-400 hover:shadow-gray-600 dark:border border-green-500 transition-all dark:bg-black bg-[#def2f1]  rounded-xl dark:text-white'>
